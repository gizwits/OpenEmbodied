...
class EyeToySingleDisplay : public Display {
private:
    ...
    lv_obj_t* star_big_ = nullptr;  // 大星星
    lv_obj_t* star_small_ = nullptr; // 小星星
    ...
    lv_obj_t* blink_mask_ = nullptr;      // 眨眼遮罩
...
public:
    // 单屏构造函数
    EyeToySingleDisplay(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
                 int width, int height, int offset_x, int offset_y,
                 bool mirror_x, bool mirror_y,
                 DisplayFonts fonts);

    ~EyeToySingleDisplay() override;
