...
void EyeDisplay::StartHappyAnimation() {
    ...
    lv_obj_set_style_img_recolor(mouth_, lv_color_make(252 ,204, 230), 0);  // 设置青色
...
void EyeDisplay::StartSadAnimation() {
    ...
    lv_obj_set_style_bg_color(right_tear_, lv_color_make(252 ,204, 230), 0); // 青色
...
void EyeDisplay::StartVertigoAnimation() {
    ...
    lv_obj_set_style_img_recolor(left_heart, lv_color_make(252 ,204, 230), 0);  // 设置为白色
    ...
    lv_obj_set_style_img_recolor(right_heart, lv_color_make(252 ,204, 230), 0);  // 设置为白色
...
void EyeDisplay::StartSleepingAnimation() {
    ...
    lv_obj_set_style_text_color(zzz1_, lv_color_make(252 ,204, 230), 0);  // 黄色
    ...
    lv_obj_set_style_text_color(zzz2_, lv_color_make(252 ,204, 230), 0);  // 黄色
    ...
    lv_obj_set_style_text_color(zzz3_, lv_color_make(252 ,204, 230), 0);  // 黄色
...
void EyeDisplay::SetupUI() {
    ...
    lv_obj_set_size(left_eye_, 40, 80);
    lv_obj_set_style_radius(left_eye_, LV_RADIUS_CIRCLE, 0);
    lv_obj_set_style_bg_color(left_eye_, lv_color_make(252 ,204, 230), 0);  // BGR: 黄色
    ...
    lv_obj_set_size(right_eye_, 40, 80);
    lv_obj_set_style_radius(right_eye_, LV_RADIUS_CIRCLE, 0);
    lv_obj_set_style_bg_color(right_eye_, lv_color_make(252 ,204, 230), 0);  // BGR: 黄色
