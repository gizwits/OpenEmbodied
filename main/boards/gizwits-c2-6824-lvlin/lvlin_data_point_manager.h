...
class LvlinDataPointManager {
public:
    static LvlinDataPointManager& GetInstance();
...
protected:
    LvlinDataPointManager() = default;
    virtual ~LvlinDataPointManager() = default;
    LvlinDataPointManager(const LvlinDataPointManager&) = delete;
    LvlinDataPointManager& operator=(const LvlinDataPointManager&) = delete;
