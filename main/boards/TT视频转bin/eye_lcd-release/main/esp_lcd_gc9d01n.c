...
static const gc9d01n_lcd_init_cmd_t vendor_specific_init_default[] = {
    ...
    /*
    官方文档GAMMA..有问题
    {0xF0, (uint8_t[]){0x80, 0x03, 0x08, 0x06, 0x05, 0x2b}, 6, 0},
    {0xF1, (uint8_t[]){0x41, 0x97, 0x98, 0x13, 0x13, 0xCD}, 6, 0},
    {0xF2, (uint8_t[]){0x40, 0x03, 0x08, 0x0b, 0x08, 0x2e}, 6, 0},
    {0xF3, (uint8_t[]){0x3f, 0x98, 0xb4, 0x14, 0x18, 0xcd}, 6, 0},
