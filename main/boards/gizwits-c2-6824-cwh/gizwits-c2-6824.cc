...
private:
    ...
    void InitializeButtons() {
        ...
        config_button_.OnPressRepeat([this](uint16_t count) {
            ESP_LOGI(TAG, "config_button_.OnPressRepeat: %d", count);
...
public:
    CustomBoard() : boot_button_(BOOT_BUTTON_GPIO), rec_button_(REC_BUTTON_GPIO), volume_button_(VOLUME_BUTTON_GPIO), config_button_(CONFIG_BUTTON_GPIO), audio_codec(CODEC_TX_GPIO, CODEC_RX_GPIO)
    {      
