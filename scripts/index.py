...
AUTH_PRODUCT_KEY = "e1e1c010f6154280b5c01c69e224bdda"  # 产品密钥
AUTH_PRODUCT_SECRET = "056dac32f5614c7bab0eb86e94ed2700"  # 产品密钥
AUTH_ORG_ID = 16561
...
def write_license_to_flash(auth_key, device_id):
    ...
    try:
        ...
        # 使用esptool写入flash
        cmd = ['esptool.py', 'write_flash', '0x100000', 'auth_data.bin']
        result = subprocess.run(cmd, capture_output=True, text=True)
        print(result)
        if result.returncode == 0:
